...
technical_analysis_config_map = {
    ...
    #               required_if=lambda: technical_analysis_config_map.get("position_management").value == "Profit_taking",
    #               type_str="decimal",
    #               default=Decimal("0"),
    ...
    #               required_if=lambda: technical_analysis_config_map.get("position_management").value == "Trailing_stop",
    #               type_str="decimal",
    #               default=Decimal("0"),
    #               validator=lambda v: validate_decimal(v, 0, 100, True),
    #               prompt_on_new=True),
    ...
    #               required_if=lambda: technical_analysis_config_map.get("order_levels").value > 1,
    #               type_str="decimal",
    ...
    #                      "(Enter 1 to indicate 1%) >>> ",
    #               required_if=lambda: technical_analysis_config_map.get("hanging_orders_enabled").value,
    #               type_str="decimal",
    #               default=Decimal("10"),
    #               validator=lambda v: validate_decimal(v, 0, 100, inclusive=False)),
    ...
    #               required_if=lambda: technical_analysis_config_map.get("order_optimization_enabled").value,
    #               type_str="decimal",
    ...
    "price_type":
        ConfigVar(key="price_type",
                  ...
                  type_str="str",
                  required_if=lambda: technical_analysis_config_map.get("price_source").value != "custom_api",
                  default="mid_price",
    ...
    #               required_if=lambda: technical_analysis_config_map.get("price_source").value == "external_market",
    #               type_str="str",
    ...
    #               required_if=lambda: technical_analysis_config_map.get(
